...
const TRACKING_INTERVAL = 2000; // 20 seconds for periodic tracking 
const HEARTBEAT_INTERVAL = 1000; // 10 seconds for heartbeat 
const INACTIVITY_THRESHOLD = 300000; // 30000 seconds until user is considered inactive
