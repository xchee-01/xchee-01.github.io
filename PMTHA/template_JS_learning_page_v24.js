...
const TRACKING_INTERVAL = 60000; // 60 seconds for periodic tracking 
const HEARTBEAT_INTERVAL = 60000; // 60 seconds for heartbeat 
const INACTIVITY_THRESHOLD = 60000; // 60000 seconds until user is considered inactive
...
const requiredPackages = ['numpy', 'pandas', 'math'];
