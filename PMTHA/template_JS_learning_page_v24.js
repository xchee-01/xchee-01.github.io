...
const TRACKING_INTERVAL = 20; // 20 seconds for periodic tracking 
const HEARTBEAT_INTERVAL = 10; // 10 seconds for heartbeat 
const INACTIVITY_THRESHOLD = 300; // 300 seconds until user is considered inactive
